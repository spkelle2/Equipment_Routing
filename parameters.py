...
def make_travel_matrix(daily_demand, file_path, region, travel_rate, day_length,
	handle):
	...
	locations.insert(0,9998)
	locations.append(9999)
	...
	for i in range(length):
	    for j in range(length):
	        ...
	        lat1 = daily_coords.loc[daily_coords['Project #'] == a, 'Lat'].iloc[0]
	        long1 = daily_coords.loc[daily_coords['Project #'] == a, 'Long'].iloc[0]

	        lat2 = daily_coords.loc[daily_coords['Project #'] == b, 'Lat'].iloc[0]
	        long2 = daily_coords.loc[daily_coords['Project #'] == b, 'Long'].iloc[0]
	        
	        # 69 miles between latitudes and 53 for longitudes
...
def make_parameters(fixed_parameters, daily_inputs, region):
	...
	travel_matrix = make_travel_matrix(daily_demand, file_path, region,
		travel_rate, day_length, handle)
